...
rtds_action_github_repo = "grburgess/polarball"
...
latex_documents = [
    (master_doc, 'polarball.tex', u'polarball Documentation',
...
man_pages = [(master_doc, 'polarball', u'polarball Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'polarball', u'polarball Documentation', author, 'polarball',
